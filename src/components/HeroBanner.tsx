      ...
      <div className="absolute inset-0 flex items-center">
        <div className="container mx-auto px-3 sm:px-4 md:px-6">
          <motion.div
            ...
            className="max-w-2xl space-y-3 sm:space-y-4 md:space-y-6"
          >
            {/* Badges */}
            ...
            {/* Title */}
            <h1 className="font-display font-bold text-2xl sm:text-4xl md:text-5xl lg:text-7xl tracking-tight leading-none">
              {content.title}
            </h1>
            ...
            {/* Description */}
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-xl line-clamp-2 sm:line-clamp-3">
              {content.description}
            </p>
            ...
            <div className="flex items-center gap-2 sm:gap-3 pt-1 sm:pt-2">
              <Link to={`/watch/${content.id}`}>
                <Button variant="play" size="lg" className="gap-2 text-sm sm:text-base">
                  <Play className="w-4 h-4 sm:w-5 sm:h-5 fill-current" />
                  Play Now
                </Button>
              </Link>
              <Link to={`/title/${content.id}`}>
                <Button variant="glass" size="lg" className="gap-2 text-sm sm:text-base">
