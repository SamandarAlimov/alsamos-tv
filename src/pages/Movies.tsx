    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 pb-20 lg:pb-12">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <div>
              <h1 className="font-display font-bold text-3xl md:text-4xl">Movies</h1>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center glass rounded-lg p-1">
                <Button variant={viewMode === 'grid' ? 'secondary' : 'ghost'} size="iconSm" onClick={() => setViewMode('grid')}>
                  <Grid className="w-4 h-4" />
                </Button>
                <Button variant={viewMode === 'list' ? 'secondary' : 'ghost'} size="iconSm" onClick={() => setViewMode('list')}>
          ...
          {filteredMovies.length === 0 && (
            <div className="text-center py-20">
              <p className="text-muted-foreground">Hozircha bu janrda kino yo'q. Tez orada qo'shiladi.</p>
            </div>
          )}
        </div>
      </div>
