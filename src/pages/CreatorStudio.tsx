...
const CreatorStudio = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-20 pb-20 lg:pb-12">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="manage" className="space-y-6">
            <TabsList className="bg-card/50 backdrop-blur-sm flex-wrap h-auto gap-1 p-1">
              <TabsTrigger value="manage" className="gap-1.5 text-xs sm:text-sm">
                <Database className="w-4 h-4" /> <span className="hidden xs:inline">Kontent</span> Boshqarish
              </TabsTrigger>
              ...
              <TabsTrigger value="content" className="gap-1.5 text-xs sm:text-sm">
                <Video className="w-4 h-4" /> Videolar
              </TabsTrigger>
