  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_30px_hsl(38,92%,50%,0.4)] hover:shadow-[0_0_50px_hsl(38,92%,50%,0.6)] font-semibold tracking-wide",
        glass: "bg-foreground/10 backdrop-blur-md text-foreground hover:bg-foreground/20 border border-foreground/10",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg",
        play: "bg-foreground text-background hover:bg-foreground/90 shadow-xl hover:scale-105",
        subtle: "bg-foreground/10 text-foreground hover:bg-foreground/20 backdrop-blur-sm",
      },
      size: {
