              ...
              <Link to={`/live/${channel.id}`}>
                <div className="group glass rounded-xl p-4 hover:ring-1 hover:ring-primary/50 transition-all duration-300 cursor-pointer">
                  <div className="flex items-center gap-4">
                    {/* Channel Logo */}
                    <div className="w-14 h-14 rounded-xl bg-secondary flex items-center justify-center text-2xl overflow-hidden flex-shrink-0">
                    ...
                    {/* Watch Button */}
                    <Button variant="subtle" size="sm" className="flex-shrink-0 hidden sm:block opacity-0 group-hover:opacity-100 transition-opacity">
                      Watch
                    </Button>
                  </div>
                </div>
